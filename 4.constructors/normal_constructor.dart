void main(List<String> args) {
  ...
  // const constructor khi truyền tham số thì các giá trị đó sẽ không thay đổi nữa
  constConstructor kConstructor = constConstructor(1, 2, 3);
  //kConstructor.a = 3; không thể thay đổi giá trị vì nó đã là final
}
...
//const Constructor chỉ nhận đối số 1 lần
class constConstructor {
  final int a, b, c;
  const constConstructor(this.a, this.b, this.c);
}
